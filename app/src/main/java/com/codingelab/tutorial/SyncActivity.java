...
public class SyncActivity extends AppCompatActivity {
    ...
    String HttpJSonURL = "http://192.168.8.108:8080/android/syncdata.php";
    ...
    private class StoreJSonDataInToSQLiteClass extends AsyncTask<Void, Void, Void> {
                    ...
                    if (FinalJSonResult != null) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                String SQLiteDataBaseQueryHolder = "INSERT INTO "+SQLiteHelper.TABLE_NAME+" (name,phone,email) VALUES('"+tempName+"', '"+tempPhone+"', '"+tempEmail+"');";
...

        {
            ...
            Toast.makeText(SyncActivity.this,"Finish", Toast.LENGTH_LONG).show();
    ...
    public void SQLiteTableBuild(){
        ...
        sqLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS "+SQLiteHelper.TABLE_NAME+"("+SQLiteHelper.Table_Column_ID+" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "+SQLiteHelper.Table_Column_Name+" VARCHAR, "+SQLiteHelper.Table_Column_Phone+" VARCHAR,"+SQLiteHelper.Table_Column_Email+" VARCHAR);");
